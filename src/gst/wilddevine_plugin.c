...
GST_PLUGIN_DEFINE(GST_VERSION_MAJOR, GST_VERSION_MINOR, wilddevine, "WildDevine plugin", plugin_init, PACKAGE_VERSION, "GPL", PACKAGE_NAME, "http://boron.roadcake.org")
